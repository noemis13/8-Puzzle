...
public class ExpandePuzzleHeuristicaIgual {
     ...
     */
    public double expandeBuscaAEstrela(String[][] puzzle, ArrayList<String[][]> puzzlePercorrido, double peçasForaDoLugar) {
        ...
        double menorValorHeuristica = 0, valorInicialPeçasForaDoLugar;
